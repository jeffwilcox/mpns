...
function PushMessage(pushType, quickNotificationClass, targetName, options) {
    ...
    if (options) {
        copyOfInterest(options, this, propertiesOfInterest,
            this.pushType === 'tile');
        copyOfInterest(options, this, sslProperties, false);
    }
}
...
PushMessage.prototype.send = function(pushUri, callback) {
    ...
    if (options.protocol == 'http:') {
        ...
        protocol = https;
        if (typeof me.pfx !== 'undefined')
            options.pfx = me.pfx;
        if (typeof me.key !== 'undefined')
            options.key = me.key;
        if (typeof me.passphrase !== 'undefined')
            options.passphrase = me.passphrase;
        if (typeof me.cert !== 'undefined')
            options.cert = me.cert;
        if (typeof me.ca !== 'undefined')
            options.ca = me.ca;
        if (typeof me.ciphers !== 'undefined')
            options.ciphers = me.ciphers;
        if (typeof me.rejectUnauthorized !== 'undefined')
            options.rejectUnauthorized = me.rejectUnauthorized;
